...
import {
    ...
    FlexStyle,
    ImgStyle,
} from "./HistoryPostStyle";

export default function HistoryPost({ post }) {
    ...
    return (
        <Container>
            <FlexedName>
                <FlexStyle>
                    <ImgStyle
                        src={`https://avatars.dicebear.com/api/bottts/${post.authorSlug}.svg`}
                        alt="author's icon"
                    />
                    <h3>{post.author}</h3>
                </FlexStyle>
            ...
            <FlexedName>
                ...
                <div>
                    <ChangedFlag
                        ...
                        onClick={flagColorToggle}
                        active={flagActive.toString()}
                    ></ChangedFlag>
                    <ChangedRetweet
                        className="fa-solid fa-retweet"
                        onClick={reTweetColorToggle}
                        active={reTweetActive.toString()}
                    ></ChangedRetweet>
                    <ChangedHeart
                        className="fa-solid fa-heart"
                        onClick={heartColorToggle}
                        active={heartActive.toString()}
                    ></ChangedHeart>
                </div>
            </FlexedName>
        </Container>
